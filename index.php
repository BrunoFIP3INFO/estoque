...
<html lang="pt-BR">
    ...
    <form action="logar.php" method="POST">
        <div class="form-group">
            <label>E-mail</label>
            <input class="form-control" type="email" name="usuario" placeholder="Digite o e-mail do usuario" autocomplete="off" />
    </div>
    ...
    <button type="submit" class="btn btn-success btn-sm btn-block">Entrar
    </button>
    <br>
    <p class="d-flex justify-content-center">Não possui cadastro?<span style="width:5px"></span><a href="cadastrar_usuario_externo.php">Clique aqui
    </a></p>
    </form>
    </div>
